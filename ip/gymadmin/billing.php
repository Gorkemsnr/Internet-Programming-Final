...
if(!isset($_SESSION['username'])){
  ...
  header('location: /ip/gymadmin/admin-login.php');
}
...
<div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="#">Spor Salonu Yönetim Sistemi</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="coach.php">Antrenör</a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link disabled" href="billing.php">Admin Yönetim</a>
      </li>
    </ul>
  </div>
</nav>
