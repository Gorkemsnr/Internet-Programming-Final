                        ...
                        <div class="main-menu f-right d-none d-lg-block">
                            <nav>
                                <ul id="navigation">
                                    ...
                                    <li><a href="gallery.php">Gallery</a></li>php
                    ...
                    <div class="properties mb-30">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                ...
                                <input type="" name="pricefp1" value="30" hidden="">
                                ...
                                <button type="submit" name="price1"> <a  class="border-btn border-btn2">Satın Al</a></button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="properties mb-30">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                <span class="month">6 month</span>
                                <p class="mb-25">$60/m  <span>(Single class)</span></p>
                                <input type="" name="pricefp2" value="60" hidden="">
                                <div class="single-features">
                                    <div class="features-icon">
                                        <img src="assets/img/icon/check.svg" alt="">
                                    </div>
                                ...
                                <button type="submit" name="price2"><a  class="border-btn border-btn2">Satın Al</a></button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="properties mb-30">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                <span class="month">6 month</span>
                                <p class="mb-25">$125/m  <span>(Single class)</span></p>
                                <input type="" name="pricefp3" value="125" hidden="">
                                <div class="single-features">
                                    <div class="features-icon">
                                        <img src="assets/img/icon/check.svg" alt="">
                                    </div>
                                ...
                                <button type="submit" name="price3"><a  class="border-btn border-btn2">Satın Al</a></button>
                            </div>
                        </div>
                    </div>
                </div>
