                ...
                <div class="container-fluid">
                    <div class="menu-wrapper d-flex align-items-center justify-content-between">
                        ...
                        <div class="main-menu f-right d-none d-lg-block">
                            <nav>
                                <ul id="navigation">
                                    ...
                                    <li><a href="pricing.php">Ödemeler</a></li>
                                    <li><a href="gallery.php">Galeri</a></li>
                                    <li><a href="blog.php">Blog</a>
                                        <ul class="submenu">
                                            <li><a href="blog.php">Blog</a></li>
                                            <li><a href="blog_details.php">Blog Detayları</a></li>
                                            <li><a href="elements.php">Elementler</a></li>
                                        </ul>
                                    </li>
                        ...
                        <div class="header-btns d-none d-lg-block f-right">
                           <a href="../smp/index.php" class="btn">Admin</a>
                       </div>
                       <!-- Mobile Menu -->
                       <div class="col-12">
                    ...
                    <div class="properties mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                ...
                                <a href="#" class="border-btn border-btn2">Şimdi Katıl</a>
                            </div>
                        </div>
                    </div>
                </div>
